...
& "G:\cdb\cdb.exe" -g -G -lines -y "$REPO\Debug" -srcpath "$REPO\SkullbonezSource" "$REPO\Debug\SKULLBONEZ_CORE.exe"
```
...
& "G:\cdb\cdb.exe" -lines -y "$REPO\Debug" -srcpath "$REPO\SkullbonezSource" "$REPO\Debug\SKULLBONEZ_CORE.exe"
```
