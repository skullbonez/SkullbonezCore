...
| Last committed milestone | Scene-to-demo world reset leak is fixed on the authoritative replay branch. |
| Active objective | Replay prediction amortization is implemented and validated. |
| Pending work | Commit and push the replay prediction amortization follow-up. |
| Blockers | None known. |
