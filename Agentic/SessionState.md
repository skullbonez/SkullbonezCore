...
| Current objective | Complete the Gate Blind Spot Campaign in binding order; Angular Impulse Frame Correctness AI2 is next. |
...
4. `Plans/TODO/angular-impulse-frame-correctness.md` (2/5, AI0-AI4) — **the only
   remaining plan and the only plan that stops for the owner.** AI2 is next.
