...
| Active objective | Owner redirected active work to `Agentic/Plans/TODO/replay-visuals-prediction-and-memory.md`. Stage 0.1 replay trajectory counters and Stage 0.2 per-category replay memory byte accounting are complete and validated; next actionable work is Stage 0.3 manual H1-H5 repro documentation. The overall engine cleanup goal remains active and incomplete. |
...
| Replay visuals/prediction/memory/size | Active plan (~24%) | `Agentic/Plans/TODO/replay-visuals-prediction-and-memory.md` - Stage 0.1 trajectory counters/reporting and Stage 0.2 byte categories are complete; next is Stage 0.3 H1-H5 manual repro documentation. Do not run its stages concurrently in separate sessions. |
