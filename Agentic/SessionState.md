...
| Current objective | Architecture Follow-Up Campaign Round 5. Plan 5 is blocked at FV1; `scene-runtime-verb-partition-consolidation` SR2 is binding. |
| Active/future progress | 7/33 (21%). Round 5 is the live queue; completed plans are excluded under rule 4. |
| UI ruling | Legacy remains the default. ImGui is explicit `--dev-ui imgui`; atomic hot swap is allowed, simultaneous Legacy/ImGui activation is forbidden. |
| Last broad local gate | Scene-runtime SR1 `validate_full.bat` passes in 244.1 s: mandatory CPU preflight and all runtime lanes, DX12 run `20260727T024014Z` with committed baselines, and byte-exact Physics. |
...
NOW. Architecture Follow-Up Campaign Round 5 is live at 7/33, registered
...
implementation units; SR2 is binding.
...
and deleted contact-tick growth. Plan 8 SR2 is now binding. Evidence:
