...
- Engine cleanup restart handoff for the current pause:
  ...
  commit before the handoff is `98e06366`; resume Plan 02 Step 1.2 from
  `contactBodyViewAtTime` only after the user restarts and resumes.
