...
| Last committed milestone | Runtime run decomposition is committed through Phase 4A on `nightrunner-24th-june-refactor`: generated/authored scene setup lives in scene helpers, and public physics handle/API scaffolding now defines the future command/query/view boundary without moving runtime behavior. |
