...
| Last committed milestone | Runtime interaction controller is retained on `nightrunner-24th-june`; the humanoid ragdoll constraints experiment was rolled back after user review. Simple ragdolls now keep fixed part colors, have a small neck swing stop, and explicit wakes spread through sleeping support piles/tree parts. |
