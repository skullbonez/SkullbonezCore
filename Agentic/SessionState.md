...
| Validation | Current generated-topology replay v2 slice is covered by `python -m py_compile tools\check_replay_v2_artifact.py tools\replay_query.py`, `tools\validate_format.bat`, targeted `tools\validate_build.bat Debug`, focused `python tools\check_replay_v2_artifact.py`, `tools\validate_fast.bat`, `tools\validate_replay_v2_artifact.bat`, and `tools\validate_full.bat`. Final logs are in `TestOutput\agent_logs\2026-06-23_validate_format_replay_v2_generated_topology_iter3.log`, `TestOutput\agent_logs\2026-06-23_replay_v2_generated_topology_debug_build_iter1.log`, `TestOutput\agent_logs\2026-06-23_replay_v2_generated_topology_checker_iter3.log`, `TestOutput\agent_logs\2026-06-23_validate_fast_replay_v2_generated_topology_final1.log`, `TestOutput\agent_logs\2026-06-23_validate_replay_v2_generated_topology_final1.log`, and `TestOutput\agent_logs\2026-06-23_validate_full_replay_v2_generated_topology_final1.log`. |
