...
| Public physics API boundary | Active plan (80%) | `engine-cleanup-plans/14-public-physics-api-boundary.md`; Steps 0.1, 1.1, 1.2, and 1.3 are complete. Remaining work is FAC-005 acceptance reconciliation. |
