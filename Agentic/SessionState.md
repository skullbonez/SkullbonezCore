...
| Active objective | Complete all fable plans. Fable-03 P3.0, fable-04 L1-L4 and C1-C5, fable-05 P3 SpatialGrid/PhysicsWorld plus GameModelCollection classification/pure topology/legacy camera pose-read/append Lane R conversions, and fable-06 Phase 1 plus Phase 2 R1/R2/R3 are complete; fable-03 P3.1-P3.4, remaining fable-04, remaining fable-05, remaining fable-06 conversions/closure, and fable-07 still have open work. |
| Last documentation milestone | `fable_plans/HANDOFF-2026-07-07.md`, `fable_plans/06-stable-identity-plan.md`, and `fable_plans/06-stable-identity-progress.md` now document fable-06 R1/R2/R3 resolver completion and updated counts. |
| Last source/data milestone | Fable-06 R1/R2/R3 is complete: `Physics::ModelRowHint`, `PhysicsBodyStore::ResolveModelRow`, and the replay-id `ModelRowHint&` resolver overload are in place; retained replay marker/camera/prediction-begin paths repair or invalidate cached model rows through the resolver; `TestPhysicsHandles.cpp` covers stale-handle invalidation and moved-row self-heal. |
| Pending work | Not all fable plans are complete. Open work remains in fable-03 P3.1-P3.4 worker-job stepping, remaining fable-04 mega-file decomposition, fable-05 loader/asset and DX12 conversions plus closure, fable-06 subsystem conversions/closure, and fable-07 per `fable_plans/HANDOFF-2026-07-07.md`; fable-01, fable-02, fable-08, and fable-09 are checklist complete. Next small slices: fable-05 P4.1 authored scene/asset loader Lane R cleanup or fable-06 C1 RuntimeTools `ModelRowHint` conversion. |
...
| Validation | Latest source gate passed on 2026-07-08 for fable-06 R1/R2/R3: touched-file comment audit inspected 6 source-bearing files with 0 deferred; `git diff --check` passed; `tools\validate_fast.bat` passed in 00:00:52.8044 with formatting, project filters, staged-size, runtime boundaries, doctests `45 | 45 passed` / `582 | 582 passed`, and Profile/Debug builds at 0 warnings/errors; `python tools\check_runtime_boundaries.py --max-errors 20` passed in 00:00:17.8207 with runtime boundaries at 0 errors. |
