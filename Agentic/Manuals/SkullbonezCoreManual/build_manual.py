            ...
            [
                SectionSpec(
                    ...
                    [
                        ...
                        "The key habit is to read ownership before reading behavior. EngineContext is a bound view over Run-owned systems. RuntimeRenderInputs is rebuilt for one render call and discarded. PhysicsModelAccess is the model-owner sync boundary between legacy GameModel storage and physics stores.",
                ...
                SectionSpec(
                    ...
                    [
                        ...
                        "Rendering follows after simulation and replay preview state have been applied. Run sets the active camera, builds RuntimeRenderInputs, calls RuntimeRenderer::RenderFrame, then restores any replay pose that was temporarily borrowed for presentation.",
                    ],
                    figure="frame_loop",
            ...
            [
                ...
                SectionSpec(
                    ...
                    [
                        ...
                        "Render code does not need the entire collection as an owner; it needs per-frame views and render instances. That is why GameModelStreamProvider and RuntimeRenderInputs matter: they mark the path from historical objects toward view-shaped data.",
                    ],
                    bullets=[
...
def worked_guides() -> list[SectionSpec]:
    return [
        ...
        SectionSpec(
            ...
            [
                "Start from Run::Render. Confirm replay preview state is applied only for the draw and restored afterward. Then look at the RuntimeRenderInputs construction to see which backend facets and runtime systems are borrowed for this frame.",
