...
8. [`agent-docs-alignment-plan.md`](Plans/Done/agent-docs-alignment-plan.md)
   - The canonical startup contract, dirty-worktree guardrails,
     agent-orchestration default, provider instructions, scoped local rules, and
     review guidance are in place.

## Active Tackle Order

1. [`water-rendering-cleanup-plan.md`](Plans/water-rendering-cleanup-plan.md)
...
2. [`dx12-render-graph-completion-plan.md`](Plans/dx12-render-graph-completion-plan.md)
   - The next focused DX12 architecture slice for graph-owned resource-state
     validation/execution.

3. [`architecture_pass_2026-06-02.md`](Plans/architecture_pass_2026-06-02.md)
...
4. [`replay-system-plan.md`](Plans/replay-system-plan.md)
...
runtime, physics, asset, parser, or render-graph boundary. Implementation work
sourced from `Agentic/Plans` defaults to
