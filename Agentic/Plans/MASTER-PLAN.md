...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 24/27 completed items | Finish F1 multi-domain settings split and broad frame-context/substitute-hub proof |
