...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Delete the B1f omnibus UI-frame callback pack and late frame/render/replay polling, then retire `RunInternal.h` and forwarding wrappers |
