...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [owner-fanout-reduction](TODO/owner-fanout-reduction.md) | Active | 4/6 | OF3 consumer outputs collapsed 20→11; proceed to OF4 frame-view diet |
