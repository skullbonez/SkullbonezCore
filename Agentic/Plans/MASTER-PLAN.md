...
|---|---:|---:|---:|
| [monolith-tu-right-sizing](TODO/monolith-tu-right-sizing.md) | 6 | 8 | 75% |
| [code-level-red-flags-remediation](TODO/code-level-red-flags-remediation.md) | 4 | 7 | 57% |
| **Active/future total** | **10** | **15** | **67%** |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [monolith-tu-right-sizing](TODO/monolith-tu-right-sizing.md) | Active | 6/8 | N6 rerun the prediction single-writer/published-prefix dependency pass and apply its extraction-or-cohesion ruling |
