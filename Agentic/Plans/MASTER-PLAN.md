...
|---|---:|---:|---:|
| [scene-controller-decomposition-round-2](TODO/scene-controller-decomposition-round-2.md) | 4 | 7 | 57% |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [scene-controller-decomposition-round-2](TODO/scene-controller-decomposition-round-2.md) | Active | 4/7 | S4 extract the concrete `SceneWorld` owner and move `StepPhysics` |
