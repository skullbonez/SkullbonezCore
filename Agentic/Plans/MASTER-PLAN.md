...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 1/26 remaining items | Wire B1c keyboard routing and delete `MappedKeyboardDispatchContext` plus its callback pack |
