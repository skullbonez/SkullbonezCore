...
`box-vibration-and-warm-start-integrity`, continuing with BV4's convergence
remeasurement after BV3 retired the terrain warm-start seed.
...
| 8 | [box-vibration-and-warm-start-integrity](TODO/box-vibration-and-warm-start-integrity.md) | In progress | 4/7 | BV3 complete: terrain fabricated-load seeds are deleted, touching terrain rows cache solved impulses, the controlled result remains zero flips/one iteration, shoreline visible sign flips improve 8→2 without a bobbing regression, and cumulative baseline regeneration remains deferred; continue BV4 |
...
- **BV3 supersedes the 2026-07-27 Round 5 ruling** that rejected replacing the
  ...
  a visible gameplay motivation now exists. The owner ratified the measured BV3
  removal on 2026-07-29.
