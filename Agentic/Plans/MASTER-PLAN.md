...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Delete the six remaining B1f UI owner-transition callbacks/broad context and complete the Run method/state deletion proof |
