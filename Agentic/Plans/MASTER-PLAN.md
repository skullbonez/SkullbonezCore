...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Complete the final B1f Run input method/state deletion proof |
