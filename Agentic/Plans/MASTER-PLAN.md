...
The Fresh-Read Engine Review Campaign (2026-07-29) is the active queue at 2/7
(29%). Plans 1-7 are complete and excluded under rule 4. Execute plan 8
`box-vibration-and-warm-start-integrity`, continuing with BV2's SAT axis-type
stabilization.
...
| 8 | [box-vibration-and-warm-start-integrity](TODO/box-vibration-and-warm-start-integrity.md) | In progress | 2/7 | BV1 complete: persistent object restitution suppression cuts the controlled metric 566→0, restores one-iteration early-out, preserves terrain-only bytes, pins fresh versus cached-load bias, and defers one cumulative baseline refresh; continue BV2 |
