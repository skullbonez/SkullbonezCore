...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Delete the broad B1f UI context and complete the final Run input method/state proof |
