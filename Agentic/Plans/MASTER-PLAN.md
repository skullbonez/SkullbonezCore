...
NOW. Architecture Follow-Up Campaign Round 5 is the live queue at 1/33 (3%).
...
`render-backend-service-bag-removal` closed RB0 on 2026-07-27; RB1 is the
binding next task.
...
| 6 | [render-backend-service-bag-removal](TODO/render-backend-service-bag-removal.md) | In progress | 1/4 | RB0 classified every construction/consumer: no external site needs more than five owners; only renderer/lifecycle touches the eight-owner epoch. **Binding next task: RB1** |
