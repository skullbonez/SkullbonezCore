...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 0/26 remaining items | Wire B2a application-exit ownership, then B1c keyboard routing and callback-pack deletion |
