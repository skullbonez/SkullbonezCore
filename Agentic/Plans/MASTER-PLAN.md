...
The Fresh-Read Engine Review Campaign (2026-07-29) is the active queue at 2/13
(15%). Plans 1-6 are complete and excluded under rule 4; execute plans 7→8 in
the listed order. Plan 7 QN2 repairs the identified composition sites next.
...
| 7 | [quaternion-convention-normalization](TODO/quaternion-convention-normalization.md) | In progress | 2/6 | QN0-QN1 complete; the canonical core and characterization tests pass, and QN2 owns the remaining Matrix4 and composition compensation before QN4's hands-on gate |
