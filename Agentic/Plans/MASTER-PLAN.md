...
| [dependency-direction-restoration](TODO/dependency-direction-restoration.md) | 2 | 6 | 33% |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [dependency-direction-restoration](TODO/dependency-direction-restoration.md) | Active — L0-L1 complete | 2/6 | Start L2 (move the replay solver snapshot into Physics and remove Physics→Replay edges); no blocker |
