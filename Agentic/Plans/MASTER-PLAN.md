...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 21/27 completed items | E1 retire `RunInternal.h` without a replacement state hub |
