...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Close B1f outer pointer routing and `TakeInput`/camera helpers, then retire `RunInternal.h` and forwarding wrappers |
