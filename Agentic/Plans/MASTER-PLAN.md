...
The Fresh-Read Engine Review Campaign (2026-07-29) is the active queue at 1/13
(8%). Plans 1-6 are complete and excluded under rule 4; execute plans 7→8 in
the listed order. Plan 7 QN1 is next after the ratified QN0 census.
...
| 7 | [quaternion-convention-normalization](TODO/quaternion-convention-normalization.md) | In progress | 1/6 | QN0 proceeding decision and live census are recorded; QN1 corrects the core while QN4 remains the hands-on gate before any baseline move |
