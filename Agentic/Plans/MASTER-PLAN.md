...
NOW. Architecture Follow-Up Campaign Round 5 is the live queue at 2/18 (11%).
...
performance gate without regression. AF1 is binding because plan 5 remains
blocked.
...
| 11 | [allocator-foreign-pointer-safety](TODO/allocator-foreign-pointer-safety.md) | In progress | 1/3 | **Binding next task: AF1**. Ratified 2026-07-27: fatal in Debug/Profile, counted in Release |
