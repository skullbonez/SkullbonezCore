...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 24/27 completed items | F1 rebuild the complete logical `Run` method/field ownership inventory |
