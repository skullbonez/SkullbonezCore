...
|---|---:|---:|---:|
| `replay-subsystem-consolidation` | 4 | 7 | 57% |
...
| [replay-subsystem-consolidation](TODO/replay-subsystem-consolidation.md) | Active | 4/7 | RC3 consolidated frame-local Presentation selection and value-only draw submission; proceed to RC4 public-header diet |
