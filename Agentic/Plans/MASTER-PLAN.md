...
|---|---:|---:|---:|
| [monolith-tu-right-sizing](TODO/monolith-tu-right-sizing.md) | 5 | 8 | 63% |
| [code-level-red-flags-remediation](TODO/code-level-red-flags-remediation.md) | 4 | 7 | 57% |
| **Active/future total** | **9** | **15** | **60%** |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [monolith-tu-right-sizing](TODO/monolith-tu-right-sizing.md) | Active | 5/8 | N5 rerun the recorder dependency pass and either extract a concrete responsibility or record the dated cohesion ruling |
