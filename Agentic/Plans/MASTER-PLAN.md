...
| [dependency-direction-restoration](TODO/dependency-direction-restoration.md) | 1 | 6 | 17% |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [dependency-direction-restoration](TODO/dependency-direction-restoration.md) | Active — L0 complete | 1/6 | Start L1 (move Runtime allocation policy to Core); no blockers |
