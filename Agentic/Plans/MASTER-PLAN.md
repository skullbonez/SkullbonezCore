...
| run-member-and-include-shrink | 2 | 6 | 33% |
...
| [run-member-and-include-shrink](TODO/run-member-and-include-shrink.md) | Active | 2/6 | T3: extract the narrowed `RuntimeValidationHarness` with live-style and graphics-stress sequencing; contact audio remains on `Run` by recorded owner ruling |
