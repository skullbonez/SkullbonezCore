...
|---|---|---|---|---|
| Causal Event Inspection | `CAUSAL_INSPECT` | 9 | 7 | `TODO/causal-event-inspection.md` |
...
1. `CAUSAL_INSPECT` C7 through C8 — complete the causal inspection plan first.
   ...
   aftermath, return, and reset edge. C7-C8 close cost evidence, tests, and
   independent review.
...
8/24 tasks complete across three active plans. Causal C7 is the next selectable
task; Causal C0-C6 and Catto CD0 are complete.
