...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 24/27 completed items | Finish F1 raw-field mapping and substitute-hub proof after deleting `RunSubsystemState` and forwarding surfaces |
