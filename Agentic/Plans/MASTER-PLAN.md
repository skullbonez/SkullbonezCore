...
| [render-hal-modernization](TODO/render-hal-modernization.md) | 3 | 6 | 50% |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [render-hal-modernization](TODO/render-hal-modernization.md) | Active | 3/6 | Start M3 retirement of global raster setters/getters and legacy desired-state tracking |
