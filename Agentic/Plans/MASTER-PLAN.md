...
| [14 Public physics API boundary](../../engine-cleanup-plans/14-public-physics-api-boundary.md) | In Progress | 20% | Inventory complete; implementation remains for typed identity/counts and solver-container removal in `PhysicsApi.h`/`PhysicsEngine.h`. |
