...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 18/27 completed items | D1 split `RunInput.cpp` along the proven owner boundaries |
