...
|---|---:|---:|---:|
| [scene-controller-decomposition-round-2](TODO/scene-controller-decomposition-round-2.md) | 5 | 7 | 71% |
...
| Plan | State | Verified phase count | Start condition / next action |
|---|---|---:|---|
| [scene-controller-decomposition-round-2](TODO/scene-controller-decomposition-round-2.md) | Active | 5/7 | S5 shrink the load participant surface against the split |
