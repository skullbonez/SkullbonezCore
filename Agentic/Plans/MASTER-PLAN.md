...
NOW. Architecture Follow-Up Campaign Round 5 is the live queue at 5/50 (10%).
`governance-shape-to-judgment-conversion` and
`extraction-scar-remediation` closed on 2026-07-27 and left the live inventory
under rule 4. Plan 2 `scene-sized-store-capacity` closed SC0-SC4; SC5 is the
binding next task.
...
| 2 | [scene-sized-store-capacity](TODO/scene-sized-store-capacity.md) | In progress | 5/8 | SC4 converts all 24 hot contact, narrowphase, broadphase, and force rows to scene-committed fixed lists; evidence is [`SC4 hot-stage lists`](../Reports/2026-07-27/scene-sized-store-capacity-sc4-hot-stage-lists.md). **Binding next task: SC5** |
