...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Close B1f `TakeInput` callback packs and late frame/render/replay polling, then retire `RunInternal.h` and forwarding wrappers |
