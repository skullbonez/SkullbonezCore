...
The Fresh-Read Engine Review Campaign (2026-07-29) is the active queue at 3/21
(14%). Plans 1-4 are complete and excluded under rule 4; execute plans 5→8 in
the listed order. Plan 5 BC3 next measures exact post-change commitment at all
three scene sizes, verifies Memory-tab owner rows, completes independent review,
and runs every mapped closure gate.
...
| 5 | [broadphase-capacity-right-sizing](TODO/broadphase-capacity-right-sizing.md) | In progress | 3/4 | BC3 measures the result, verifies owner telemetry, passes independent review, and runs closure gates |
