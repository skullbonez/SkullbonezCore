...
| [runtime-shell-decomposition](TODO/runtime-shell-decomposition.md) | In progress | 17/27 completed items | Move the two remaining B1f camera/editor-mode transitions to their owners, delete the broad UI context, and complete the Run method/state proof |
...
| [physics-authority-and-identity](TODO/physics-authority-and-identity.md) | In progress | 11/16 current items | A1/A3 coordinated mutation/deletion, then D1-D2 and D4 stored-identity cleanup |
