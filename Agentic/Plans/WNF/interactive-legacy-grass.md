...
Date: 2026-09-17
Status: WNF - owner-requested plan only; 0/7 phases complete.
...
This plan remains parked in WNF until the owner explicitly activates it. It
does not start implementation, change active portfolio totals, retire Cine
mode, or authorize changes to the ongoing Split Future work. Drafting this
plan requires no runtime validation. Recheck repository instructions and follow
`Agentic/Skills/orchestrator/SKILL.md` when activated.
...
- [ ] **IG0 - Audit and settle contracts.** Confirm existing grass/render paths,
...
- [ ] **IG1 - Render rooted grass in legacy mode.** Add bounded instanced blades,
...
- [ ] **IG2 - Add object flattening and recovery.** Implement bounded world-space
...
- [ ] **IG3 - Integrate time and lifecycle.** Bind pause/step/reset, generation
...
- [ ] **IG4 - Finish quality and performance.** Add distance detail, culling,
...
- [ ] **IG5 - Complete native acceptance and visual tuning.** Exercise every
