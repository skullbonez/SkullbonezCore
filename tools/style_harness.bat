@rem
@rem File: tools/style_harness.bat
@rem Purpose:
@rem   Documents and runs the style_harness.bat developer/validation helper script.
@rem
@rem Mental model:
...
@rem
@echo off
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0style_harness.ps1" %*
