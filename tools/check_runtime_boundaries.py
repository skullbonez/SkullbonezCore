...
GLOBAL_SERVICE_ACCESS_ALLOWLIST: Counter[tuple[Path, str]] = Counter(
    {
        ...
        for path, label, count in (
            ...
            ( "SkullbonezSource/Runtime/Run.cpp", "Cfg()", 9 ),
            ...
            ( "SkullbonezSource/Runtime/RunFrame.cpp", "Cfg()", 4 ),
            ...
            ( "SkullbonezSource/Runtime/RunInteractionAutomation.cpp", "Cfg()", 1 ),
            ( "SkullbonezSource/Runtime/RunLiveStyle.cpp", "Cfg()", 1 ),
            ( "SkullbonezSource/Runtime/RunPasses.cpp", "Cfg()", 2 ),
