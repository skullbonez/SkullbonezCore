...
#   - Agentic/Plans/IN PROGRESS/carmack-render-graph-resource-ownership-plan.md
...
PHYSICS_GAME_MODEL_COLLECTION_ALLOWLIST: Counter[tuple[Path, str]] = Counter(
    ...
    for path, line in (
        ...
        ( "SkullbonezSource/Physics/Debug/PhysicsDebugVisualizer.cpp", "GameModelCollection& models," ),
        ...
        ( "SkullbonezSource/Physics/Debug/PhysicsDebugVisualizer.h", "GameObjects::GameModelCollection& models," ),
...
GLOBAL_SERVICE_ACCESS_ALLOWLIST: Counter[tuple[Path, str]] = Counter(
    {
        ...
        for path, label, count in (
            ...
            ( "SkullbonezSource/Runtime/Init.cpp", "EngineConfig::Instance()", 2 ),
            ...
            ( "SkullbonezSource/Runtime/Diagnostics/DiagnosticsRuntime.cpp", "Profiler::Instance()", 2 ),
            ( "SkullbonezSource/Runtime/Run.cpp", "Gfx()", 1 ),
            ( "SkullbonezSource/Runtime/Run.cpp", "GfxRayTracing()", 1 ),
