...
# FABLE-05 P3/P4: invariant conversions, the scene-parser missing-camera
# result path, and Terrain RAW load result path lowered the tracked
# exception-site budget without approving replacement throws.
