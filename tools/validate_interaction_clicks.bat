...
echo   TestOutput\interaction\launcher_fire_click_report.json
echo   TestOutput\interaction\replay_prediction_click_report.json
echo   TestOutput\interaction\editor_undo_redo_report.json
...
echo   TestOutput\interaction\launcher_fire_after_click.bmp
echo   TestOutput\interaction\replay_prediction_after_click.bmp
echo   TestOutput\interaction\editor_after_place.bmp
echo   TestOutput\interaction\editor_transform_ready.bmp
popd >nul
exit /b 0
