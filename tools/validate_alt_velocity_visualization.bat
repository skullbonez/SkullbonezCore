...
REM   N-body scene, proving prediction stays visible and rebuilds once on release.
REM
REM Invariants:
...
REM   - No superseded prediction restart is allowed during one drag.
setlocal
...
echo [alt-velocity] Report: TestOutput\interaction\nbody_velocity_drag_instant_report.json
