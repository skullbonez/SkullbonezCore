...
for %%s in (blur_off blur_on blur_moved_off blur_moved_on profiler_default profiler_hierarchy profiler_timeline physics_toggles scene_options controls renderer_combo scene_complete small_scroll controls_bottom controls_bottom_bg min_size min_size_bg minimized performance_histogram) do (
