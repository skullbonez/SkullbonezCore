...
for %%t in (causal_viewports velocity_pointer velocity_divergence velocity_reveal editor_velocity velocity_path_capacity scrubber_autohide header_autohide tools_diagnostics memory_ui floating_diagnostics docked_navigation ui_themes ui_side_panels ui_panel_transitions unified_preferences_ui unified_compact_tools_ui unified_editor_ui unified_options_keys_ui unified_physics_ui) do (
    call :native_case %%t
