...
Image.open(r'Y:\SkullbonezCore\Debug\screenshot_reset.bmp').save(r'Y:\SkullbonezCore\Skills\skore-render-test\baseline_water_ball_test_reset.png')
...
Image.open(r'Y:\SkullbonezCore\Debug\legacy_smoke_reset.bmp').save(r'Y:\SkullbonezCore\Skills\skore-render-test\baseline_legacy_smoke_reset.png')
