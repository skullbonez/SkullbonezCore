...
| `CMakeLists.txt`, `Core/PlatformWin32.h`, `Core/PlatformPosix.h`, or `Core/FloatingPointContract.h` portable-build behavior | `validate_fast`, then configure and build the `skullbonez_portable_cpu` CMake target |
