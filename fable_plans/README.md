...
| [02-global-service-retirement-plan.md](02-global-service-retirement-plan.md) | [progress](02-global-service-retirement-progress.md) | Global service accessors + singleton lifetime hazards (`Cfg()` and `EngineConfig::Instance()` deleted; `Gfx()`/Profiler cleanup remains) | Coordinates with `authoritative-plan-03-explicit-service-contexts` |
