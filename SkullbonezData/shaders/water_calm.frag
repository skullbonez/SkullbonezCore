...
void main()
{
    ...
    if (uCinematicMode > 0.5 && uWaterMode == 4)
    {
        ...
        vec3 deep = vec3(0.014, 0.095, 0.14);
        vec3 mid = vec3(0.045, 0.23, 0.29);
        vec3 shallow = vec3(0.30, 0.47, 0.40);
        waterColor = mix(deep, mid, 0.18 + depthBand * 0.48);
        ...
        waterColor = mix(waterColor, waterColor * vec3(0.64, 0.78, 0.78), panelEdge * 0.18);
        ...
        waterColor += uSunColor * sunShard * 0.18;
    }
