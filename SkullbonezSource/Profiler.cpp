/*
File: SkullbonezSource/Profiler.cpp
Purpose:
...
void Profiler::RenderOverlay( float xLeft, float yAnchor, float lineHeight, float fSize, float fps, bool rightAnchored )
    const
{
