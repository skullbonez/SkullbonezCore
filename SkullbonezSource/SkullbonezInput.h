...
struct InputState
{
    bool fUp, fDown, fLeft, fRight, fAux1, fAux2, fGKeyWasDown, fRKeyWasDown, f9WasDown, f0WasDown, fF2WasDown, fF3WasDown, fFWasDown, fPWasDown, fNWasDown, fZWasDown, fXWasDown;
    long xMove, yMove;
};
