...
constexpr int EDITOR_MINI_PALETTE_ENTRY_COUNT = static_cast<int>( sizeof( kEditorMiniPaletteEntries ) /
                                                                  sizeof( kEditorMiniPaletteEntries[0] ) );
...
void DrawHitboxRect( const UIDrawContext& draw, const UIRect& bounds, float r, float g, float b, float fillA = 0.060f,
...
void DrawEditorMiniVariantMarker( const UIDrawContext& draw, const UIRect& bounds, int variant,
