...
inline constexpr RenderSliderSpec kRenderSliderSpecs[] = {
    ...
    { UIRenderAuthoringSection::Shadows,
      "Depth bias",
      UIRenderParam::ShadowDepthBias,
      0.00000f,
      0.00500f,
      0.00001f,
      "%.5f" },
    ...
    { UIRenderAuthoringSection::TerrainMaterials,
      "Ball roughness",
      UIRenderParam::BallRoughness,
      0.25f,
      2.00f,
      0.01f,
      "%.2f" },
    ...
    { UIRenderAuthoringSection::TerrainMaterials,
      "Box specular",
      UIRenderParam::BoxSpecular,
      0.00f,
      2.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Future width",
      UIRenderParam::TrajectoryFutureWidth,
      1.00f,
      6.00f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Future opacity",
      UIRenderParam::TrajectoryFutureAlpha,
      0.05f,
      1.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Future edge feather",
      UIRenderParam::TrajectoryFutureEdgeFeather,
      0.25f,
      1.25f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Causal width",
      UIRenderParam::TrajectoryCausalWidth,
      1.00f,
      6.00f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Causal opacity",
      UIRenderParam::TrajectoryCausalAlpha,
      0.05f,
      1.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Causal edge feather",
      UIRenderParam::TrajectoryCausalEdgeFeather,
      0.25f,
      1.25f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Baseline width",
      UIRenderParam::TrajectoryBaselineWidth,
      1.00f,
      6.00f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Baseline opacity",
      UIRenderParam::TrajectoryBaselineAlpha,
      0.05f,
      1.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Baseline edge feather",
      UIRenderParam::TrajectoryBaselineEdgeFeather,
      0.25f,
      1.25f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Marker width",
      UIRenderParam::TrajectoryMarkerWidth,
      1.00f,
      6.00f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Marker opacity",
      UIRenderParam::TrajectoryMarkerAlpha,
      0.05f,
      1.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Marker edge feather",
      UIRenderParam::TrajectoryMarkerEdgeFeather,
      0.25f,
      1.25f,
      0.05f,
      "%.2f px" },
    { UIRenderAuthoringSection::PredictionPaths,
      "Selected emphasis",
      UIRenderParam::TrajectorySelectedEmphasis,
      0.00f,
      1.00f,
      0.01f,
      "%.2f" },
...
inline constexpr CinematicSliderSpec kCinematicSliderSpecs[] = {
    ...
    { UIRenderAuthoringSection::Lighting,
      "Sun elevation",
      UICinematicParam::SunElevation,
      0.00f,
      1.00f,
      0.005f,
      "%.3f" },
    { UIRenderAuthoringSection::Lighting,
      "Sun brightness",
      UICinematicParam::SunBrightness,
      0.00f,
      40.00f,
      0.10f,
      "%.1f" },
    ...
    { UIRenderAuthoringSection::Environment,
      "Cloud coverage",
      UICinematicParam::CloudCoverage,
      0.00f,
      1.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::Environment,
      "Cloud softness",
      UICinematicParam::CloudSoftness,
      0.01f,
      0.65f,
      0.01f,
      "%.2f" },
    ...
    { UIRenderAuthoringSection::Environment,
      "Cloud intensity",
      UICinematicParam::CloudIntensity,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    ...
    { UIRenderAuthoringSection::Post,
      "Volume strength",
      UICinematicParam::VolumetricStrength,
      0.00f,
      2.00f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::Post,
      "Volume density",
      UICinematicParam::VolumetricDensity,
      0.00f,
      2.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::Post,
      "Volume decay",
      UICinematicParam::VolumetricDecay,
      0.800f,
      0.995f,
      0.001f,
      "%.3f" },
    { UIRenderAuthoringSection::Post,
      "Bloom threshold",
      UICinematicParam::BloomThreshold,
      0.00f,
      4.00f,
      0.01f,
      "%.2f" },
    ...
    { UIRenderAuthoringSection::TerrainMaterials,
      "Terrain relief",
      UICinematicParam::TerrainRelief,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Ground R",
      UICinematicParam::TerrainTintRed,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Ground G",
      UICinematicParam::TerrainTintGreen,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Ground B",
      UICinematicParam::TerrainTintBlue,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Accent R",
      UICinematicParam::TerrainAccentRed,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Accent G",
      UICinematicParam::TerrainAccentGreen,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Accent B",
      UICinematicParam::TerrainAccentBlue,
      0.00f,
      1.50f,
      0.01f,
      "%.2f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Grid scale",
      UICinematicParam::TerrainGridScale,
      0.10f,
      120.00f,
      0.10f,
      "%.1f" },
    { UIRenderAuthoringSection::TerrainMaterials,
      "Grid strength",
      UICinematicParam::TerrainGridStrength,
      0.00f,
      4.00f,
      0.01f,
      "%.2f" },
    ...
    { UIRenderAuthoringSection::Water,
      "Water reflection",
      UICinematicParam::WaterReflection,
      0.00f,
      1.00f,
      0.01f,
      "%.2f" },
