...
constexpr float UI_NUDGE_PROJECTILE_SPEED_MIN = 20.0f;
constexpr float UI_NUDGE_PROJECTILE_SPEED_MAX = 360.0f;
constexpr float UI_NUDGE_PROJECTILE_SPEED_STEP = 5.0f;
