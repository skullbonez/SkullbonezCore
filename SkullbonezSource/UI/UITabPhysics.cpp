...
void SetToggleBounds(
    SkullbonezCore::UI::PhysicsTab::UIPhysicsTabState& state,
    int index,
    int row,
    int column,
    float col1,
...
)
{
    ...
    state.launcherProjectileSpeedSlider
        .SetBounds( contentX, contentBaseY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, contentW, 34.0f );
    state.worldGravitySlider.SetBounds( contentX, contentBaseY + PHYSICS_WORLD_GRAVITY_SLIDER_Y, contentW, 34.0f );
    state.terrainFrictionSlider
        .SetBounds( contentX, contentBaseY + PHYSICS_TERRAIN_FRICTION_SLIDER_Y, contentW, 34.0f );
    state.objectFrictionSlider.SetBounds( contentX, contentBaseY + PHYSICS_OBJECT_FRICTION_SLIDER_Y, contentW, 34.0f );
    state.rollingFrictionSlider
        .SetBounds( contentX, contentBaseY + PHYSICS_ROLLING_FRICTION_SLIDER_Y, contentW, 34.0f );
...
)
{
    ...
    else if ( state.alphaSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewAlpha =
            state.alphaSlider
                .ValueFromMouse( mouseX, UI_PHYSICS_ALPHA_MIN, UI_PHYSICS_ALPHA_MAX, UI_PHYSICS_ALPHA_STEP );
    ...
    else if ( state.contactLingerSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewContactLinger =
            state.contactLingerSlider
                .ValueFromMouse( mouseX, UI_CONTACT_LINGER_MIN, UI_CONTACT_LINGER_MAX, UI_CONTACT_LINGER_STEP );
    ...
    else if ( state.rayImpulseSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewRayImpulse =
            state.rayImpulseSlider
                .ValueFromMouse( mouseX, UI_RAY_IMPULSE_MIN, UI_RAY_IMPULSE_MAX, UI_RAY_IMPULSE_STEP );
    ...
    else if ( state.launcherProjectileSpeedSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewLauncherProjectileSpeed = state.launcherProjectileSpeedSlider.ValueFromMouse(
            mouseX,
    ...
    else if ( state.worldGravitySlider.HitTest( mouseX, mouseY ) )
    {
        ...
        result.commands.water.requestedWorldGravity = WorldGravityFromStrength(
            state.worldGravitySlider
                .ValueFromMouse( mouseX, UI_WORLD_GRAVITY_MIN, UI_WORLD_GRAVITY_MAX, UI_WORLD_GRAVITY_STEP )
        );
        return true;
    }
    else if ( state.terrainFrictionSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTerrainFriction =
            state.terrainFrictionSlider
                .ValueFromMouse( mouseX, UI_FRICTION_COEFF_MIN, UI_FRICTION_COEFF_MAX, UI_FRICTION_COEFF_STEP );
    ...
    else if ( state.rollingFrictionSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewRollingFriction = state.rollingFrictionSlider.ValueFromMouse(
            mouseX,
    ...
    else if ( state.tornadoRadiusSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTornadoRadius =
            state.tornadoRadiusSlider
                .ValueFromMouse( mouseX, UI_TORNADO_RADIUS_MIN, UI_TORNADO_RADIUS_MAX, UI_TORNADO_RADIUS_STEP );
    ...
    else if ( state.tornadoHeightSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTornadoHeight =
            state.tornadoHeightSlider
                .ValueFromMouse( mouseX, UI_TORNADO_HEIGHT_MIN, UI_TORNADO_HEIGHT_MAX, UI_TORNADO_HEIGHT_STEP );
    ...
    else if ( state.tornadoInwardSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTornadoInward =
            state.tornadoInwardSlider
                .ValueFromMouse( mouseX, UI_TORNADO_INWARD_MIN, UI_TORNADO_INWARD_MAX, UI_TORNADO_INWARD_STEP );
    ...
    else if ( state.tornadoSwirlSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTornadoSwirl =
            state.tornadoSwirlSlider
                .ValueFromMouse( mouseX, UI_TORNADO_SWIRL_MIN, UI_TORNADO_SWIRL_MAX, UI_TORNADO_SWIRL_STEP );
    ...
    else if ( state.tornadoLiftSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewTornadoLift =
            state.tornadoLiftSlider
                .ValueFromMouse( mouseX, UI_TORNADO_LIFT_MIN, UI_TORNADO_LIFT_MAX, UI_TORNADO_LIFT_STEP );
...
)
{
    ...
    state.launcherProjectileSpeedSlider
        .SetBounds( contentX, scrolledY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, contentW, 34.0f );
    if ( IsRowVisible( contentY, contentH, scrolledY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, 34.0f ) )
    {
        state.launcherProjectileSpeedSlider.Draw(
            draw,
            "Projectile speed",
            buf,
    ...
    {
        state.terrainFrictionSlider.Draw(
            draw,
            "Terrain friction",
            buf,
    ...
    {
        state.rollingFrictionSlider.Draw(
            draw,
            "Rolling friction",
            buf,
