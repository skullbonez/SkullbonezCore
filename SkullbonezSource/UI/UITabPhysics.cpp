                       ...
                       float contentW )
{
    ...
    state.launcherProjectileSpeedSlider.SetBounds( contentX, contentBaseY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, contentW, 34.0f );
                         ...
                         float contentW )
{
    ...
    else if ( state.launcherProjectileSpeedSlider.HitTest( mouseX, mouseY ) )
    {
        ...
        state.previewLauncherProjectileSpeed = state.launcherProjectileSpeedSlider.ValueFromMouse( mouseX, UI_LAUNCHER_PROJECTILE_SPEED_MIN, UI_LAUNCHER_PROJECTILE_SPEED_MAX, UI_LAUNCHER_PROJECTILE_SPEED_STEP );
           ...
           int mouseY )
{
    ...
    const float displayLauncherProjectileSpeed = ( activeSlider == SLIDER_LAUNCHER_PROJECTILE_SPEED && state.previewLauncherProjectileSpeed >= 0.0f ) ? state.previewLauncherProjectileSpeed : data.launcherProjectileSpeed;
    ...
    DrawContentToggle( draw, contentY, contentH, state.toggles[11], col2, scrolledY + PHYSICS_FIRST_TOGGLE_Y + CONTENT_TOGGLE_ROW_H * 5.0f, colW, "Ray visual", data.rayCastVisualization );
    ...
    state.launcherProjectileSpeedSlider.SetBounds( contentX, scrolledY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, contentW, 34.0f );
    if ( IsRowVisible( contentY, contentH, scrolledY + PHYSICS_LAUNCHER_PROJECTILE_SPEED_SLIDER_Y, 34.0f ) )
    {
        state.launcherProjectileSpeedSlider.Draw( draw, "Projectile speed", buf, displayLauncherProjectileSpeed, UI_LAUNCHER_PROJECTILE_SPEED_MIN, UI_LAUNCHER_PROJECTILE_SPEED_MAX );
    }
