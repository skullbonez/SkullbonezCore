/*
File: SkullbonezSource/SkullbonezContactSolverCommon.h
Purpose:
...
inline float ComputeStaticBodyEffectiveMass( float invMass, const Math::Vector::Vector3& axis, const Math::Vector::Vector3& r, ApplyInvInertia applyInvInertia )
{
...
inline float ComputeTwoBodyEffectiveMass( float invMassA, float invMassB, const Math::Vector::Vector3& axis, const Math::Vector::Vector3& rA, const Math::Vector::Vector3& rB, ApplyInvInertiaA applyInvInertiaA, ApplyInvInertiaB applyInvInertiaB )
{
    ...
    const float k = invMassA + invMassB +
                    axis * Math::Vector::CrossProduct( applyInvInertiaA( rAxAxis ), rA ) +
