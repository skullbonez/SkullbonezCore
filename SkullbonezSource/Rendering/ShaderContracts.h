...
inline constexpr GenerateMipsDispatchPlan PlanGenerateMipsDispatch( unsigned int sourceWidth, unsigned int sourceHeight, unsigned int remainingMipCount )
{
    ...
    while ( plan.mipCount < remainingMipCount && plan.mipCount < 4 && ( plan.finalWidth == 1 || ( plan.finalWidth & 1u ) == 0 ) && ( plan.finalHeight == 1 || ( plan.finalHeight & 1u ) == 0 ) )
    {
...
{
    static constexpr ShaderVertexInputContract contracts[] = { { "collision_visualizer", "POSITION0:xyz:NONE,NORMAL0:xyz:NONE,TEXCOORD1:xyzw:NONE,TEXCOORD2:xyzw:NONE,TEXCOORD3:xyzw:NONE,TEXCOORD4:" "xyzw:NONE,TEXCOORD5:xyzw:NONE" },
                                                               ...
                                                               { "lit_textured_instanced", "POSITION0:xyz:NONE,NORMAL0:xyz:NONE,TEXCOORD0:xy:NONE,TEXCOORD1:xyzw:NONE,TEXCOORD2:xyzw:NONE,TEXCOORD3:" "xyzw:NONE,TEXCOORD4:xyzw:NONE,TEXCOORD5:xyzw:NONE,TEXCOORD6:xyzw:NONE,TEXCOORD7:xyzw:NONE,TEXCOORD8:xyzw:" "NONE" },
                                                               { "post_smaa_edges", "POSITION0:xy:NONE,TEXCOORD0:xy:NONE" },
                                                               { "post_smaa_weights", "POSITION0:xy:NONE,TEXCOORD0:xy:NONE" },
                                                               { "post_smaa_blend", "POSITION0:xy:NONE,TEXCOORD0:xy:NONE" },
                                                               ...
                                                               { "shadow_depth_instanced", "POSITION0:xyz:NONE,TEXCOORD1:xyzw:NONE,TEXCOORD2:xyzw:NONE,TEXCOORD3:xyzw:NONE,TEXCOORD4:xyzw:NONE" },
                                                               ...
                                                               { "retained_ribbon", "POSITION0:xyz:NONE,TEXCOORD0:xyzw:NONE,TEXCOORD1:xyzw:NONE,TEXCOORD2:xy:NONE,TEXCOORD3:xyz:NONE," "TEXCOORD4:xyz:NONE,SV_VertexID0:x:VERTID" },
                                                               { "surface_blades", "POSITION0:xyz:NONE,TEXCOORD0:xyzw:NONE,TEXCOORD1:xyzw:NONE,TEXCOORD2:xy:NONE,TEXCOORD3:xyz:NONE," "TEXCOORD4:xyz:NONE,TEXCOORD5:xyzw:NONE,TEXCOORD6:xyz:NONE,TEXCOORD7:xyzw:NONE,SV_VertexID0:x:VERTID" },
...
inline bool ShaderContractMatchesBaseName( const char* baseName, const char* pathOrBaseName )
{
    ...
    return baseName && std::strlen( baseName ) == candidateLength && std::strncmp( baseName, candidate, candidateLength ) == 0;
}
...
{
    static constexpr ShaderUniformDecl collisionVisualizerUniforms[] = { { "uView", ShaderValueType::Mat4, true },
                                                                         { "uProjection", ShaderValueType::Mat4, true },
                                                                         { "uClipPlane", ShaderValueType::Vec4, true },
                                                                         { "uLightPosition", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl viewProjectionUniforms[] = { { "uViewProj", ShaderValueType::Mat4, true }, };
    static constexpr ShaderUniformDecl gridLineUniforms[] = { { "uViewProj", ShaderValueType::Mat4, true }, { "uViewportPixels", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl shadowDepthUniforms[] = { { "uModel", ShaderValueType::Mat4, true },
                                                                 { "uView", ShaderValueType::Mat4, true },
                                                                 { "uProjection", ShaderValueType::Mat4, true },
                                                                 { "uClipPlane", ShaderValueType::Vec4, true },
                                                                 { "uCinematicTerrain", ShaderValueType::Vec4, true },
                                                                 { "uCinematicBasin", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl shadowDepthInstancedUniforms[] = { { "uView", ShaderValueType::Mat4, true }, { "uProjection", ShaderValueType::Mat4, true }, { "uClipPlane", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl solidColorUniforms[] = { { "uProjection", ShaderValueType::Mat4, true }, { "uColor", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl projectionUniforms[] = { { "uProjection", ShaderValueType::Mat4, true }, };
    static constexpr ShaderUniformDecl retainedRibbonUniforms[] = { { "uViewProj", ShaderValueType::Mat4, true }, { "uViewportPixels", ShaderValueType::Vec4, true }, { "uRibbonStyle", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl previewUniforms[] = { { "uProjection", ShaderValueType::Mat4, true }, { "uPreviewParams", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl backdropBlurUniforms[] = { { "uProjection", ShaderValueType::Mat4, true }, { "uTexelSize", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl unlitTexturedUniforms[] = { { "uModel", ShaderValueType::Mat4, true },
                                                                   { "uView", ShaderValueType::Mat4, true },
                                                                   { "uProjection", ShaderValueType::Mat4, true },
                                                                   { "uColorTint", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl litTexturedInstancedUniforms[] = { { "uView", ShaderValueType::Mat4, true },
                                                                          { "uProjection", ShaderValueType::Mat4, true },
                                                                          { "uClipPlane", ShaderValueType::Vec4, true },
                                                                          { "uLightPosition", ShaderValueType::Vec4, true },
    ...
    static constexpr ShaderUniformDecl litTexturedUniforms[] = { { "uModel", ShaderValueType::Mat4, true },
                                                                 { "uView", ShaderValueType::Mat4, true },
                                                                 { "uProjection", ShaderValueType::Mat4, true },
                                                                 { "uClipPlane", ShaderValueType::Vec4, true },
                                                                 { "uLightPosition", ShaderValueType::Vec4, true },
    ...
    static constexpr ShaderUniformDecl waterCalmUniforms[] = { { "uModel", ShaderValueType::Mat4, true },
                                                               { "uView", ShaderValueType::Mat4, true },
                                                               { "uProjection", ShaderValueType::Mat4, true },
    ...
    static constexpr ShaderUniformDecl waterOceanUniforms[] = { { "uModel", ShaderValueType::Mat4, true },
                                                                { "uView", ShaderValueType::Mat4, true },
                                                                { "uProjection", ShaderValueType::Mat4, true },
                                                                { "uReflectVP", ShaderValueType::Mat4, true },
                                                                { "uColorTint", ShaderValueType::Vec4, true },
    ...
    static constexpr ShaderUniformDecl skyAtmosphereUniforms[] = { { "uSunParams", ShaderValueType::Vec4, true },
                                                                   { "uSunColor", ShaderValueType::Vec3, true },
    ...
    static constexpr ShaderUniformDecl smaaUniforms[] = { { "uSmaaMetrics", ShaderValueType::Vec4, true } };
    static constexpr ShaderUniformDecl tonemapUniforms[] = { { "uExposure", ShaderValueType::Float, true },
    ...
    static constexpr ShaderUniformDecl volumetricUniforms[] = { { "uDepthParams", ShaderValueType::Vec4, true },
                                                                { "uSunShaftParams", ShaderValueType::Vec4, true },
                                                                { "uSunColor", ShaderValueType::Vec3, true },
                                                                { "uVolumetricParams", ShaderValueType::Vec4, true }, };
    static constexpr ShaderUniformDecl imagePairUniforms[] = { { "uPair", ShaderValueType::Vec4, true }, { "uTexel", ShaderValueType::Vec4, true } };
    static constexpr ShaderUniformDecl pairedOutlineUniforms[] = { { "uModelViewProjection", ShaderValueType::Mat4, true }, { "uOutlineViewport", ShaderValueType::Vec4, true } };
    static constexpr ShaderProgramDesc contracts[] = { { "image_pair", "post", "FullscreenP2_UV2", imagePairUniforms, 2, nullptr, 0 },
                                                       { "paired_outline",
                                                                                                                                         "debug",
                                                                                                                                         "EdgeEndpoints3_Corner2",
                                                                                                                                         pairedOutlineUniforms,
                                                                                                                                         2,
                                                                                                                                         nullptr,
                                                                                                                                         0 },
                                                       ...
                                                       { "grid_line",
                                                                                                                                                       "debug",
                                                                                                                                                       "LineEndpointPair3_Color3",
                                                                                                                                                       gridLineUniforms,
                                                                                                                                                       sizeof( gridLineUniforms ) / sizeof( gridLineUniforms[0] ),
                                                                                                                                                       nullptr,
                                                                                                                                                       0 },
                                                       { "launcher_laser",
                                                                                                                                                              "effects",
