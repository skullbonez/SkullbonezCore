...
class Dx12GeometryOwner
{
  ...
  private:
    ...
    void DrawColoredTrianglesFromBuffer( std::size_t packedFloatCount,
                                         ...
                                         Dx12DrawGate& drawGate,
                                         Dx12Diagnostics& diagnostics );
    void DrawCompactRibbonsFromBuffer( std::size_t packedFloatCount,
                                       const Math::Transformation::Matrix4& viewProjection,
                                       TransientTriangleStyle style,
                                       int viewportWidth,
                                       int viewportHeight,
    ...
    void SubmitColoredTriangleBuffer( std::size_t packedFloatCount,
                                      TransientTriangleStyle style,
...
{
  public:
    Dx12RaytracingOwner( SkullbonezCore::Core::SbDiagnosticStore& resultDiagnostics,
