...
class Window
{
  ...
  private:
    SkullbonezCore::Core::SbDiagnosticStore&
        m_resultDiagnostics;                                                       // Process diagnostic lease owner borrowed for the window lifetime.
  ...
  public:
    ...
    CreateAppWindow( HINSTANCE hInstance, bool isFullScreenMode,
    ...
    int MsgBox( const char* cMsgBoxText, const char* cMsgBoxTitle,
