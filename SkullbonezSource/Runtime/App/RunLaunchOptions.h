...
struct RunLaunchOptions
{
    ...
    SkullbonezCore::Core::Allocation::RuntimeAllocationGuardMode allocationGuardMode = SkullbonezCore::Core::
        Allocation::RuntimeAllocationGuardMode::Off; // CLI --allocation-guard tracking mode for
