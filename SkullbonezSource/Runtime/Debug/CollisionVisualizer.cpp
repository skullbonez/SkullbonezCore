...
{
  public:
    CollisionVisualizerTraceScope( IRenderDiagnostics& renderDiagnostics, const char* name )
  ...
  private:
    IRenderDiagnostics& m_renderDiagnostics;
    uint32_t m_hash = 0;
};
} // namespace
...
{
    // Lifetime: explicit runtime teardown passes the live resource factory so the
