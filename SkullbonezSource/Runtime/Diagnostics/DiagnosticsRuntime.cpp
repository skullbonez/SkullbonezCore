                                              ...
                                              double nowSeconds )
{
    ...
    fprintf(
        ...
        static_cast<unsigned long long>( stats.gameObjects.modelVectorBytes + stats.gameObjects.modelReplayIdBytes ),
        static_cast<unsigned long long>( stats.gameObjects.modelVectorBytes ),
        static_cast<unsigned long long>( stats.gameObjects.modelReplayIdBytes ),
