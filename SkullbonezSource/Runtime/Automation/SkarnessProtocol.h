...
inline constexpr std::array SKARNESS_CAPABILITIES = { SkarnessCapability { "editor.set_enabled", "Editor", "{enabled:bool}" },
                         ...
                         "Input",
                         "{button:left|right|middle,x:int,y:int,deltaX:int,deltaY:int,moveClient?:bool,holdMilliseconds?:" "int,holdAfterMoveMilliseconds?:int,movementFrames?:int,rawInput?:bool}",
                         SkarnessCapabilityAvailability::AutomatedInputOnly }, };
