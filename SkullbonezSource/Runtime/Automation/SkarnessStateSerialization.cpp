...
void BuildSkarnessStateTopics( const SkarnessFrameState& state, const ReplayAutomationView& replay, SkarnessStateDetail detail, SkarnessSerializedStateTopics& outTopics )
{
    ...
    Store( outTopics, Presentation, { { "layout", state.presentation.editorLayout ? "Editor" : "Canvas" },
                           ...
                           { "gravityGridVertexCount", state.presentation.gravityGridVertexCount },
                           { "gravityGridSourceCount", state.presentation.gravityGridSourceCount },
                           ...
                           { "tornadoVisualSeconds", state.presentation.tornadoVisualSeconds },
                           { "tornadoVisualVortices", state.presentation.tornadoVisualVortices },
                           { "tornadoVisualVertices", state.presentation.tornadoVisualVertices },
                           ...
                           { "gravityFieldSnapBalls", state.presentation.gravityFieldSnapBalls },
                           { "gravityFieldSnappedCount", state.presentation.gravityFieldSnappedCount },
                           { "gravityFieldFirstSnappedId", state.presentation.gravityFieldFirstSnappedId },
                           { "gravityFieldFirstSnappedPosition", state.presentation.gravityFieldFirstSnappedPosition },
                           { "gravityFieldFirstSnappedRadius", state.presentation.gravityFieldFirstSnappedRadius },
                           { "gravityFieldFirstSnappedSurfaceHeight", state.presentation.gravityFieldFirstSnappedSurfaceHeight },
