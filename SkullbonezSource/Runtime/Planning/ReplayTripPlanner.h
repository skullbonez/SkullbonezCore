...
class ReplayTripPlanner
{
  public:
    ...
    FirstOrderCorrection( const Math::Vector::Vector3& velocity, const Math::Vector::Vector3& shipAtClosest, const Math::Vector::Vector3& targetAtClosest, float closestTimeSeconds ) noexcept;
