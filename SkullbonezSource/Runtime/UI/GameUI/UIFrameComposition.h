...
const char* const kCameraModeOptions[CAMERA_MODE_OPTION_COUNT] = { "Demo", "Scene", "Inspect", "Attach", "Launcher", "Manipulator", "Director" };
...
void DrawEditorObjectCounter( const UIDrawContext& draw, const InGameUIFrameData& data, int screenW, int screenH, const UIRect* avoidBounds = nullptr );
...
constexpr int EDITOR_MINI_RAGDOLL_MODE_COUNT = 4;
constexpr int EDITOR_MINI_FLYOUT_OPTION_MAX = 4;
...
constexpr EditorMiniPaletteEntry kEditorMiniPaletteEntries[] = { { EditorTab::OBJECT_BOX, EDITOR_MINI_TREE_PLACEMENT_NONE, EDITOR_MINI_HOLD_MODE_NONE },
