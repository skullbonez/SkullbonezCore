...
class AttachedCameraController
{
  public:
    ...
    static bool TryAttachTargetHandlesFromModelIndex(
        const Runtime::SceneWorld& collection,
        int modelIndex,
    ...
    static bool TryResolvePhysicsTarget(
        const Runtime::SceneWorld& collection,
        AttachedCameraTarget& target,
