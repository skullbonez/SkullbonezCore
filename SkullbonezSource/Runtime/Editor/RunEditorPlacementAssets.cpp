...
constexpr EditorTreePartDefinition MakeEditorTreePart( const EditorTreePartDesc& desc )
{
    return EditorTreePartDefinition{
        .hullAsset = desc.hullAsset,
        .suffix = desc.suffix,
        .offsetX = desc.offsetX,
        .offsetY = desc.offsetY,
        .offsetZ = desc.offsetZ,
        .restitution = desc.restitution,
        .materialKind = desc.materialKind,
        ...
        .stylization = desc.stylization,
        .startsFixed = desc.startsFixed,
        .contactReleaseOnImpact =
            desc.contactReleaseOnImpact || EditorHullAssetDefaultsToContactRelease( desc.hullAsset ),
        .contactReleaseImpulseThreshold = desc.contactReleaseImpulseThreshold };
}
...
{
    return MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::TREE_ROOT_SMALL,
                                                   .suffix = "root",
                                                   .offsetX = 0.0f,
                                                   .offsetY = 0.55f,
                                                   .offsetZ = 0.0f,
...
{
    return MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::TREE_ROOT_LARGE,
                                                   .suffix = "root",
                                                   .offsetX = 0.0f,
                                                   .offsetY = 0.75f,
                                                   .offsetZ = 0.0f,
...
{
    return MakeEditorTreePart(
        EditorTreePartDesc{ .hullAsset = EditorHullAsset::PINE_NEEDLE_CLUSTER,
                            .suffix = suffix,
                            .offsetX = offsetX,
                            .offsetY = offsetY,
                            .offsetZ = offsetZ,
...
constexpr EditorTreePartDefinition EDITOR_TREE_SMALL_PARTS[] = {
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::TREE_TRUNK_SMALL_FACETED,
                                            .suffix = "trunk",
                                            .offsetX = 0.0f,
                                            .offsetY = 6.5f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.06f,
                                            .stylization = 0.50f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::CEDAR_TIER_LOW,
                                            .suffix = "low",
                                            .offsetX = 0.0f,
                                            .offsetY = 20.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.08f,
                                            .stylization = 0.90f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::CEDAR_TIER_MID,
                                            .suffix = "mid",
                                            .offsetX = 0.0f,
                                            .offsetY = 28.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.08f,
                                            .stylization = 0.90f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::CEDAR_TIER_TOP,
                                            .suffix = "top",
                                            .offsetX = 0.0f,
                                            .offsetY = 35.0f,
                                            .offsetZ = 0.0f,
...
constexpr EditorTreePartDefinition EDITOR_TREE_BIG_PARTS[] = {
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::TREE_TRUNK_FACETED,
                                            .suffix = "trunk",
                                            .offsetX = 0.0f,
                                            .offsetY = 9.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.06f,
                                            .stylization = 0.48f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::PINE_TIER_LARGE,
                                            .suffix = "low",
                                            .offsetX = 0.0f,
                                            .offsetY = 24.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.08f,
                                            .stylization = 0.88f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::PINE_TIER_MID,
                                            .suffix = "mid",
                                            .offsetX = 0.0f,
                                            .offsetY = 34.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.08f,
                                            .stylization = 0.88f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::PINE_TIER_TOP,
                                            .suffix = "top",
                                            .offsetX = 0.0f,
                                            .offsetY = 43.0f,
                                            .offsetZ = 0.0f,
...
constexpr EditorTreePartDefinition EDITOR_TREE_CEDAR_PARTS[] = {
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::TREE_TRUNK_FACETED,
                                            ...
                                            .specular = 0.06f,
                                            .stylization = 0.50f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::CEDAR_TIER_TALL_LOW,
                                            .suffix = "low",
                                            .offsetX = 0.0f,
                                            .offsetY = 25.0f,
                                            .offsetZ = 0.0f,
                                            ...
                                            .specular = 0.08f,
                                            .stylization = 0.90f } ),
    MakeEditorTreePart( EditorTreePartDesc{ .hullAsset = EditorHullAsset::CEDAR_TIER_TALL_MID,
                                            .suffix = "mid",
                                            .offsetX = 0.0f,
                                            .offsetY = 38.0f,
                                            .offsetZ = 0.0f,
