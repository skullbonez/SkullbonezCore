/*
File: SkullbonezSource/Runtime/Interaction/RuntimeInteractionController.h
Purpose:
...
class RuntimeInteractionController
{
  public:
    ...
    RuntimeInteractionTransition SetWorldInteractionOwnerInWorkspace(
