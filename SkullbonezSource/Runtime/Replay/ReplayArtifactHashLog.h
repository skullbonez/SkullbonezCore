...
{
  public:
    void Configure( const char* requestedPath, ReplayRecorderConfig& presentationConfig, ReplayRecorderConfig& solverConfig,
                    const ReplayRecorderStats& presentationStats, const ReplayRecorderStats& solverStats );
