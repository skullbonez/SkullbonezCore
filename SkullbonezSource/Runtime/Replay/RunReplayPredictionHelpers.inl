                                            ...
                                            double )
{
    ...
    // Why: contact topology should appear as one complete prediction graph.
    // Incremental cache growth can make manifold rings blink between draw
    // slices when the prediction budget is tight.
