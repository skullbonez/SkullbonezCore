...
ObjectContactCandidateSelection SelectObjectContactCandidateIndices( const ObjectContactCandidate* candidates, int candidateCount, const Math::Vector::Vector3& normal );
