...
class PhysicsEngine
{
  public:
    ...
    RegisterAuthoredBody( const PhysicsBodyCreateDesc& body, PhysicsColliderCreateDesc collider );
    ...
    bool ReleaseFixedBodyAndAttachedTreeParts(
