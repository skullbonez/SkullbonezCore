...
class AssetSystem
{
  public:
    ...
    const TextureSourceAsset& RegisterTextureSourceAsset( const char* logicalName, const char* relativePath, uint32_t legacyHash, bool generateMips = true, bool linearFilter = true, int channelsHint = 3 );
    ...
    const ShaderSourceAsset& RegisterShaderSourceAsset( const char* logicalName, const char* baseName, ShaderProgramKind kind = ShaderProgramKind::Unknown, ShaderProgramContract contract = {} );
