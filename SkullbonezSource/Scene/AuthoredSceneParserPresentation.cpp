...
void AuthoredSceneParser::ApplyCinematicFloat( const Json& cinematic, const std::string& path )
{
    ...
    static constexpr FloatField kFields[] = {
        ...
        { "sunIntensity", &SkullbonezCore::Core::CinematicRenderConfig::sunIntensity, SCENE_CINE_SUN_INTENSITY, 0.0f, 80.0f },
        ...
        { "skyGlowStrength", &SkullbonezCore::Core::CinematicRenderConfig::skyGlowStrength, SCENE_CINE_SKY_GLOW_STRENGTH, 0.0f, 16.0f },
        { "cloudCoverage", &SkullbonezCore::Core::CinematicRenderConfig::cloudCoverage, SCENE_CINE_CLOUD_COVERAGE, 0.0f, 1.0f },
        { "cloudSoftness", &SkullbonezCore::Core::CinematicRenderConfig::cloudSoftness, SCENE_CINE_CLOUD_SOFTNESS, 0.001f, 1.0f },
        { "cloudScale", &SkullbonezCore::Core::CinematicRenderConfig::cloudScale, SCENE_CINE_CLOUD_SCALE, 0.1f, 64.0f },
        { "cloudIntensity", &SkullbonezCore::Core::CinematicRenderConfig::cloudIntensity, SCENE_CINE_CLOUD_INTENSITY, 0.0f, 4.0f },
        { "sunShaftStrength", &SkullbonezCore::Core::CinematicRenderConfig::sunShaftStrength, SCENE_CINE_SUN_SHAFT_STRENGTH, 0.0f, 8.0f },
        { "sunShaftFalloff", &SkullbonezCore::Core::CinematicRenderConfig::sunShaftFalloff, SCENE_CINE_SUN_SHAFT_FALLOFF, 0.1f, 10.0f },
        { "volumetricStrength", &SkullbonezCore::Core::CinematicRenderConfig::volumetricStrength, SCENE_CINE_VOLUMETRIC_STRENGTH, 0.0f, 8.0f },
        { "volumetricDensity", &SkullbonezCore::Core::CinematicRenderConfig::volumetricDensity, SCENE_CINE_VOLUMETRIC_DENSITY, 0.0f, 8.0f },
        { "volumetricDecay", &SkullbonezCore::Core::CinematicRenderConfig::volumetricDecay, SCENE_CINE_VOLUMETRIC_DECAY, 0.0f, 1.0f },
        { "bloomThreshold", &SkullbonezCore::Core::CinematicRenderConfig::bloomThreshold, SCENE_CINE_BLOOM_THRESHOLD, 0.0f, 16.0f },
        { "bloomKnee", &SkullbonezCore::Core::CinematicRenderConfig::bloomKnee, SCENE_CINE_BLOOM_KNEE, 0.001f, 8.0f },
        { "bloomStrength", &SkullbonezCore::Core::CinematicRenderConfig::bloomStrength, SCENE_CINE_BLOOM_STRENGTH, 0.0f, 8.0f },
        { "bloomRadius", &SkullbonezCore::Core::CinematicRenderConfig::bloomRadius, SCENE_CINE_BLOOM_RADIUS, 0.1f, 32.0f },
        { "terrainRelief", &SkullbonezCore::Core::CinematicRenderConfig::terrainRelief, SCENE_CINE_TERRAIN_RELIEF, 0.0f, 4.0f },
        { "basinDepth", &SkullbonezCore::Core::CinematicRenderConfig::basinDepth, SCENE_CINE_BASIN_DEPTH, 0.0f, 256.0f },
        { "basinRimLift", &SkullbonezCore::Core::CinematicRenderConfig::basinRimLift, SCENE_CINE_BASIN_RIM_LIFT, 0.0f, 256.0f },
        ...
        { "fogMaxOpacity", &SkullbonezCore::Core::CinematicRenderConfig::fogMaxOpacity, SCENE_CINE_FOG_MAX_OPACITY, 0.0f, 1.0f },
    };
    ...
    static constexpr ShadowFloatField kShadowFields[] = {
        ...
        { "shadowDepthBias", &SkullbonezCore::Core::ShadowQualityConfig::depthBias, SCENE_CINE_SHADOW_DEPTH_BIAS, 0.0f, 0.05f },
        { "shadowSlopeBias", &SkullbonezCore::Core::ShadowQualityConfig::slopeBias, SCENE_CINE_SHADOW_SLOPE_BIAS, 0.0f, 0.05f },
        { "shadowMaxDistance", &SkullbonezCore::Core::ShadowQualityConfig::maxDistance, SCENE_CINE_SHADOW_MAX_DISTANCE, 128.0f, 10000.0f },
    };
