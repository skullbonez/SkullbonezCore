/*
File: SkullbonezSource/SkullbonezLauncherLaser.cpp
Purpose:
...
Related:
  - SkullbonezSource/SkullbonezLauncherLaser.h
...
void LauncherLaser::EmitShot( const Shot& shot )
{
    ...
    const Vector3 screenUp = NormalizeOr( shot.cameraUp, NormalizeOr( CrossProduct( screenRight, dir ), Vector3( 0.0f, 1.0f, 0.0f ) ) );

    EmitRibbon( shot.start, shot.end, screenRight, LASER_AFTERIMAGE_HALF_WIDTH, 0.02f, 0.45f, 1.0f, 0.12f * afterimageFade );
    EmitRibbon( shot.start, shot.end, screenUp, LASER_AFTERIMAGE_HALF_WIDTH * 0.55f, 0.06f, 0.82f, 1.0f, 0.08f * afterimageFade );
