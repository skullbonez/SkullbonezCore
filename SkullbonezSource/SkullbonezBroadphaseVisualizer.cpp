...
void BroadphaseVisualizer::Update( float dt, const SpatialGrid::ActiveCell* activeCells, int activeCellCount, const int64_t* collisionKeys, int collisionKeyCount )
{
    if ( !m_enabled )
    {
        return;
