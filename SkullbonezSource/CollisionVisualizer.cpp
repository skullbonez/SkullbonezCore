/*
File: SkullbonezSource/CollisionVisualizer.cpp
Purpose:
...
Related:
  - SkullbonezSource/CollisionVisualizer.h
...
void CollisionVisualizer::BuildSphereMesh()
{
    ...
    m_sphereInstMesh = Gfx().CreateInstancedMesh( verts.data(),
                                                  m_sphereVertexCount,
                                                  6,
                                                  MAX_GAME_MODELS,
                                                  INSTANCE_FLOATS,
...
void CollisionVisualizer::BuildBoxMesh()
{
    ...
    int staticAttribSizes[] = { 3, 3 };
    int instanceAttribSizes[] = { 4, 4, 4, 4, 4 };
    m_boxInstMesh = Gfx().CreateInstancedMesh( verts.data(),
                                               m_boxVertexCount,
                                               6,
                                               MAX_GAME_MODELS,
                                               INSTANCE_FLOATS,
