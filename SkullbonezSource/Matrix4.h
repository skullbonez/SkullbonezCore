/*
File: SkullbonezSource/Matrix4.h
Purpose:
...
class Matrix4
{
  ...
  public:
    ...
    static Matrix4
    RotateAxis( float angleDeg, float axisX, float axisY, float axisZ ); // Axis-angle rotation using degrees.
    static Matrix4
