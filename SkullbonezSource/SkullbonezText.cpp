...
{
	if (Text2d::fontTexture) { glDeleteTextures(1, &Text2d::fontTexture);      Text2d::fontTexture = 0; }
	if (Text2d::textVBO)     { glDeleteBuffers(1, &Text2d::textVBO);           Text2d::textVBO     = 0; }
	if (Text2d::textVAO)     { glDeleteVertexArrays(1, &Text2d::textVAO);      Text2d::textVAO     = 0; }
...
void Text2d::Render2dText(float xPosition,
						  ...
						  ...)
{
	if (!cRawText || !Text2d::pTextShader) return;
	...
	for (int i = 0; i < len && (vertCount + 6) <= 512 * 6; ++i)
	{
		...
		if (c < 32 || c > 127) { penX += fSize * 0.5f; continue; }
		...
		// Triangle 1
		v[ 0]=x0; v[ 1]=y0; v[ 2]=u0; v[ 3]=v1;
		v[ 4]=x1; v[ 5]=y0; v[ 6]=u1; v[ 7]=v1;
		v[ 8]=x1; v[ 9]=y1; v[10]=u1; v[11]=v0;
		// Triangle 2
		v[12]=x0; v[13]=y0; v[14]=u0; v[15]=v1;
		v[16]=x1; v[17]=y1; v[18]=u1; v[19]=v0;
		v[20]=x0; v[21]=y1; v[22]=u0; v[23]=v0;
